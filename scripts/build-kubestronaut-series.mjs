...
${guide.body}
  ...
  <script defer src="../settings.js?v=17"></script>
  <script type="module" src="../highlighter.js?v=2"></script>
  <script defer src="../reader.js?v=3"></script>
</body>
</html>
`;
}
...
<link rel="stylesheet" href="style.css?v=89"><script src="/theme-init.js?v=9"></script><link rel="icon" type="image/svg+xml" href="assets/favicon.svg">
...
<body class="kubestronaut-series-page"><div class="layout">${sidebar("")}<div class="page">
  ...
  <footer class="footer"><span>&copy; cvam — written in plaintext, served warm</span></footer>
</div></div><script src="posts.js?v=2"></script><script src="stats.js?v=2"></script><script src="app.js?v=43"></script><script defer src="settings.js?v=17"></script><script defer src="reader.js?v=3"></script></body></html>
`;
}
