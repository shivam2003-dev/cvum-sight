...
<script src="/theme-init.js?v=5"></script>
...
${guide.body}
  ...
  <script defer src="../settings.js?v=14"></script>
...
<link rel="stylesheet" href="style.css?v=73"><link rel="stylesheet" href="/themes.css?v=5"><script src="/theme-init.js?v=5"></script><link rel="icon" type="image/svg+xml" href="assets/favicon.svg">
...
<body class="kubestronaut-series-page"><div class="layout">${sidebar("")}<div class="page">
  ...
  <footer class="footer"><span>&copy; cvam — written in plaintext, served warm</span></footer>
</div></div><script src="posts.js?v=2"></script><script src="stats.js?v=2"></script><script src="app.js?v=37"></script><script defer src="settings.js?v=14"></script><script defer src="reader.js?v=2"></script></body></html>
`;
}
