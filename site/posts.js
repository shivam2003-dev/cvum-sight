...
const POSTS = [
  ...
  },
  {
    ...
    time: 10,
    words: 2043,
    excerpt: "Token demand is now large enough to repay the activation energy of specialized ASICs, kernels, and data centers.",
  ...
  },
  {
    ...
    time: 11,
    words: 2232,
    excerpt: "Beginners use LLMs to write competitive GPU kernels—and the same agents exploit every weakness in the benchmark.",
    series: "yc-paper-club",
    seriesNum: "13"
  },
  {
    ...
    time: 10,
    words: 2127,
    excerpt: "Useful capability per watt turns local-versus-cloud inference into a measurable routing decision.",
    series: "yc-paper-club",
    seriesNum: "12"
  },
  {
    ...
    time: 11,
    words: 2295,
    excerpt: "ParallelKittens organizes multi-GPU design around transfer mechanism, overlap schedule, and library overhead.",
    series: "yc-paper-club",
    seriesNum: "11"
  },
  ...
  { slug:"deepseek-10-5-frontier-comparison", title:"DeepSeek-V4 vs GPT-5.4 vs Gemini 3.1 Pro.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1530, excerpt:"A dated, methodology-aware comparison of openness, modality, context, deployment, agent interfaces, economics, and benchmark evidence as of July 30, 2026.", series:"deepseek", seriesNum:"10.5" },
  { slug:"deepseek-10-4-beyond-cuda", title:"AI Infrastructure Beyond CUDA.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1470, excerpt:"What DeepSeek’s workloads demand from accelerators and interconnects: FP8 tiles, sparse experts, low-latency collectives, memory, compiler stacks, and portability.", series:"deepseek", seriesNum:"10.4" },
  { slug:"deepseek-10-3-million-token-context", title:"Engineering a Million-Token Context Window.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1508, excerpt:"Attention, KV cache, positional generalization, retrieval quality, prefill, decode, memory, distributed serving, and evaluations that expose fake long context.", series:"deepseek", seriesNum:"10.3" },
  { slug:"deepseek-10-2-v4-architecture", title:"DeepSeek-V4 Architecture: What Actually Changed.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1522, excerpt:"The official 2026 preview: V4-Pro and Flash, CSA+HCA hybrid attention, mHC, Muon, 32T+ tokens, reasoning modes, and million-token efficiency.", series:"deepseek", seriesNum:"10.2" },
  { slug:"deepseek-10-1-agentic-architecture", title:"DeepSeek for Agentic Systems.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1504, excerpt:"Perceive-plan-act loops, tool schemas, state, memory, verification, context management, security, and how V3.2/V4 reasoning changes the agent stack.", series:"deepseek", seriesNum:"10.1" },
  { slug:"deepseek-9-6-test-time-compute", title:"Test-Time Compute Scaling.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1503, excerpt:"Longer reasoning, best-of-N, majority voting, search, verifiers, adaptive budgets, scaling curves, latency, and the economics of spending inference compute.", series:"deepseek", seriesNum:"9.6" },
  { slug:"deepseek-9-5-self-verification", title:"Self-Verification: Capability, Pattern, or Illusion?", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1514, excerpt:"Separate internal checking, sampled reflection, external verifiers, process rewards, tool use, and redundant loops in reasoning models.", series:"deepseek", seriesNum:"9.5" },
  { slug:"deepseek-9-4-emergent-reasoning", title:"Emergent Reasoning in R1-Zero.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1528, excerpt:"What the paper actually shows about longer reasoning, reflection, self-correction, benchmark growth, readability problems, and the limits of the word 'emergent.'", series:"deepseek", seriesNum:"9.4" },
  { slug:"deepseek-9-3-grpo-vs-ppo", title:"GRPO vs PPO: A Worked Derivation.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1514, excerpt:"Policy ratios, clipping, KL control, group-normalized advantages, the removed critic, memory savings, bias, and implementation pitfalls.", series:"deepseek", seriesNum:"9.3" },
  { slug:"deepseek-9-2-rlvr", title:"Reinforcement Learning With Verifiable Rewards.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1511, excerpt:"Why math and code permit objective rewards, how outcome and format signals work, where reward hacking appears, and how RLVR differs from preference RL.", series:"deepseek", seriesNum:"9.2" },
  { slug:"deepseek-9-1-r1-architecture", title:"DeepSeek-R1: Architecture and Training Pipeline.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1521, excerpt:"R1-Zero, cold-start data, reasoning RL, rejection-sampling SFT, final RL, distilled models, rewards, and what 'architecture' really means here.", series:"deepseek", seriesNum:"9.1" },
  { slug:"deepseek-8-8-memory-optimization", title:"GPU Memory Optimization for Giant MoE Models.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1483, excerpt:"Weights, gradients, optimizer state, activations, communication buffers, KV cache, checkpointing, ZeRO, precision, and a defensible memory budget.", series:"deepseek", seriesNum:"8.8" },
  { slug:"deepseek-8-7-communication", title:"Communication Bottlenecks in MoE Training.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1489, excerpt:"A practical network model for all-to-all traffic, topology, overlap, congestion, precision, and why communication can dominate accelerator arithmetic.", series:"deepseek", seriesNum:"8.7" },
  { slug:"deepseek-8-6-expert-parallelism", title:"Expert Parallelism at Scale.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1503, excerpt:"Token dispatch, expert placement, node-limited routing, grouped GEMM, load balance, and the two all-to-all operations inside every MoE layer.", series:"deepseek", seriesNum:"8.6" },
  { slug:"deepseek-8-5-distributed-training", title:"Distributed Training for DeepSeek-Scale MoE.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1489, excerpt:"Data, pipeline, expert, tensor, and optimizer-state parallelism; how V3 combines them and why DualPipe is necessary.", series:"deepseek", seriesNum:"8.5" },
  { slug:"deepseek-8-4-sparse-economics", title:"The Economics of Sparse Compute.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1493, excerpt:"Why 671B total and 37B active change FLOPs, memory, communication, utilization, serving, and cost in different ways.", series:"deepseek", seriesNum:"8.4" },
  { slug:"deepseek-8-3-loss-free-balancing", title:"Auxiliary-Loss-Free Load Balancing.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1527, excerpt:"The bias controller behind V3’s balanced experts: selection versus weighting, update dynamics, residual sequence loss, and operational telemetry.", series:"deepseek", seriesNum:"8.3" },
  { slug:"deepseek-8-2-v3-architecture", title:"DeepSeek-V3 Architecture Explained.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1509, excerpt:"A source-checked tour of 671B/37B, 14.8T tokens, MLA, 256 routed experts, MTP depth one, FP8, DualPipe, and post-training.", series:"deepseek", seriesNum:"8.2" },
  { slug:"deepseek-8-1-v2-architecture", title:"DeepSeek-V2 Architecture Breakdown.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1500, excerpt:"How MLA and DeepSeekMoE combine in the 236B/21B model, with configuration, training, post-training, economics, and the design lineage to V3.", series:"deepseek", seriesNum:"8.1" },
  { slug:"deepseek-7-6-fp8-pipeline", title:"DeepSeek-V3’s End-to-End FP8 Pipeline.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1526, excerpt:"The complete low-precision training system: operator policy, fine-grained scales, accurate accumulation, communication precision, stability evidence, and cost claims.", series:"deepseek", seriesNum:"7.6" },
  { slug:"deepseek-7-5-online-quantization", title:"Online Quantization During Training.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1523, excerpt:"Dynamic activation scales, static weight scales, distribution drift, calibration, kernel fusion, and the cost of quantizing every step.", series:"deepseek", seriesNum:"7.5" },
  { slug:"deepseek-7-4-accumulation-precision", title:"Accumulation Precision and FP8 Stability.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1505, excerpt:"Low-precision products, wide accumulators, partial sums, error growth, and the hardware behavior DeepSeek had to work around.", series:"deepseek", seriesNum:"7.4" },
  { slug:"deepseek-7-3-fine-grained-fp8", title:"Fine-Grained FP8 Quantization in DeepSeek.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1522, excerpt:"DeepSeek-V3’s tile and block scaling: why activation outliers demand local scales and what custom kernels must do.", series:"deepseek", seriesNum:"7.3" },
  { slug:"deepseek-7-2-mixed-precision", title:"Mixed-Precision Training Explained.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1543, excerpt:"Why BF16, FP16, and FP32 coexist in one training step, how autocast and loss scaling work, and which operations must stay precise.", series:"deepseek", seriesNum:"7.2" },
  { slug:"deepseek-7-1-quantization", title:"LLM Quantization: The Complete Mental Model.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1560, excerpt:"From FP32 to FP8 and INT4: scales, zero points, granularity, calibration, outliers, PTQ, QAT, memory, bandwidth, and accuracy.", series:"deepseek", seriesNum:"7.1" },
  { slug:"deepseek-6-6-speculative-decoding", title:"Speculative Decoding With MTP Drafts.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1559, excerpt:"Draft several tokens cheaply, verify them in parallel, preserve the target distribution, and understand when MTP helps—or does not.", series:"deepseek", seriesNum:"6.6" },
  { slug:"deepseek-6-5-mtp-from-scratch", title:"MTP From Scratch in PyTorch.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1512, excerpt:"Add a sequential DeepSeek-style MTP branch to a tiny causal Transformer with correct shifts, shared parameters, losses, and tests.", series:"deepseek", seriesNum:"6.5" },
  { slug:"deepseek-6-4-mtp-training", title:"MTP Training Architecture and Stability.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1587, excerpt:"Tensor alignment, gradient flow, loss scheduling, parameter sharing, distributed placement, and diagnostics for a stable MTP training run.", series:"deepseek", seriesNum:"6.4" },
  { slug:"deepseek-6-3-deepseek-mtp", title:"How DeepSeek Redesigned MTP.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1607, excerpt:"DeepSeek-V3’s sequential MTP modules preserve a causal chain, share expensive endpoints, and can disappear cleanly at inference.", series:"deepseek", seriesNum:"6.3" },
  { slug:"deepseek-6-2-mtp-introduction", title:"Multi-Token Prediction From First Principles.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1621, excerpt:"Predict several future offsets from every position, understand the loss, and see why this is a training objective rather than permission to emit tokens independently.", series:"deepseek", seriesNum:"6.2" },
  { slug:"deepseek-6-1-ntp-limitations", title:"Why Next-Token Prediction Is Limited.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1664, excerpt:"The standard language-model objective is powerful but locally supervised; this article separates what it learns brilliantly from what it does not explicitly reward.", series:"deepseek", seriesNum:"6.1" },
  { slug:"deepseek-5-7-moe-from-scratch", title:"Coding DeepSeekMoE From Scratch.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-5"], time:8, words:1671, excerpt:"A faithful, readable PyTorch MoE block: SwiGLU experts, sigmoid routing, top-k dispatch, shared experts, balancing bias, tests, and cost accounting.", series:"deepseek", seriesNum:"5.7" },
  // END GENERATED DEEPSEEK COMPLETION
  { slug:"cv-szeliski-15-conclusion", title:"Computer Vision Chapter 15 — Conclusion.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","synthesis","chapter-15"], time:7, words:900, excerpt:"A systems-level synthesis of physics, geometry, learning, optimization, uncertainty, evaluation, and responsible deployment." },
  { slug:"cv-szeliski-14-image-based-rendering", title:"Computer Vision Chapter 14 — Image-Based Rendering.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","novel-view","chapter-14"], time:7, words:850, excerpt:"View interpolation, depth warping, disocclusion, layered depth, light fields, reflectance, and neural rendering." },
  { slug:"cv-szeliski-13-3d-reconstruction", title:"Computer Vision Chapter 13 — 3D Reconstruction.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","3d","chapter-13"], time:7, words:850, excerpt:"Point clouds, occupancy, TSDF fusion, surface extraction, meshes, texture mapping, neural fields, and evaluation." },
  { slug:"cv-szeliski-12-depth-estimation", title:"Computer Vision Chapter 12 — Depth Estimation.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","stereo","chapter-12"], time:7, words:815, excerpt:"Stereo geometry, cost volumes, regularization, occlusion, multi-view, active sensing, monocular depth, and metrics." },
  { slug:"cv-szeliski-11-structure-from-motion-slam", title:"Computer Vision Chapter 11 — Structure from Motion and SLAM.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","slam","chapter-11"], time:7, words:900, excerpt:"Camera pose, triangulation, bundle adjustment, loop closure, maps, drift, gauge freedom, and system evaluation." },
  { slug:"cv-szeliski-10-computational-photography", title:"Computer Vision Chapter 10 — Computational Photography.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","imaging","chapter-10"], time:7, words:900, excerpt:"HDR, denoising, deblurring, super-resolution, matting, compositing, active illumination, and mobile pipelines." },
  { slug:"cv-szeliski-9-motion-estimation", title:"Computer Vision Chapter 9 — Motion Estimation.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","motion","chapter-9"], time:7, words:900, excerpt:"Optical flow, tracking, regularization, coarse-to-fine estimation, motion boundaries, occlusion, and evaluation." },
  { slug:"cv-szeliski-8-image-alignment-stitching", title:"Computer Vision Chapter 8 — Image Alignment and Stitching.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","alignment","chapter-8"], time:7, words:900, excerpt:"Parametric warps, direct alignment, homographies, bundle refinement, panorama projection, seams, and blending." },
  { slug:"cv-szeliski-7-feature-detection-matching", title:"Computer Vision Chapter 7 — Feature Detection and Matching.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","features","chapter-7"], time:7, words:900, excerpt:"Edges, corners, scale and rotation invariance, descriptors, nearest-neighbor matching, and geometric verification." },
  { slug:"cv-szeliski-6-recognition", title:"Computer Vision Chapter 6 — Recognition.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","recognition","chapter-6"], time:7, words:900, excerpt:"Classification, detection, segmentation, pose, metrics, data bias, open sets, and modern recognition systems." },
  { slug:"cv-szeliski-5-deep-learning", title:"Computer Vision Chapter 5 — Deep Learning.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","deep-learning","chapter-5"], time:7, words:900, excerpt:"Neural building blocks, convolution, backpropagation, training objectives, architectures, regularization, and diagnosis." },
  { slug:"cv-szeliski-4-model-fitting-optimization", title:"Computer Vision Chapter 4 — Model Fitting and Optimization.", date:"Jul 28, 2026", cat:"book-notes", tags:["computer-vision","optimization","chapter-4"], time:7, words:900, excerpt:"Least squares, robust losses, RANSAC, probabilistic inference, gradient methods, sparse structure, and uncertainty." },
  {
  ...
  },
  {
    ...
    date: "Jul 28, 2026",
    cat: "book-notes",
    tags: ["speech-language-processing", "nlp", "speech", "chapter-25", "book-notes"],
    time: 23,
    words: 4544,
    excerpt: "Turn-taking, adjacency pairs, grounding, repair, dialog acts, conversational corpora, context, initiative, and evaluation. First-principles master's companion with derivation, worked case, evaluation, pitfalls, and study lab."
  },
  {
...
const RESOURCES = [
  ...
  { path: "speech-language-processing.html", kind: "extra", cat: "book-notes", title: "Speech and Language Processing — Complete Chapter Notes", tags: ["speech-language-processing","nlp","speech","language-models","book-notes","jurafsky","martin"], excerpt: "Complete 25-chapter, 114,000+ word first-principles companion to Jurafsky and Martin's January 2026 third-edition draft, written for master's students with derivations, worked stories, evaluation, failure modes, and study labs." },
  ...
  { path: "posts/rlai-17-frontiers.html", kind: "extra", cat: "book-notes", title: "Sutton & Barto Chapter 17 — Frontiers", tags: ["reinforcement-learning","chapter-17","frontiers","general-value-functions","options","state","reward-design"], excerpt: "Open directions in prediction, temporal abstraction, state construction, reward design, continual learning, safety, and the societal effects of capable agents." },
