...
const POSTS = [
  {
    ...
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["protocol", "ai-native", "a2a", "agent-interop"],
    time: 9,
    words: 1200,
    excerpt: "A2A is an agent-to-agent interoperability protocol for discovering capabilities and coordinating across agent systems."
  },
  {
    slug: "ain-agno",
    title: "Agno — lightweight, model-agnostic agents in pure Python.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "agno", "agents", "python"],
    time: 12,
    words: 1200,
    excerpt: "Agno (formerly Phidata) is a lightweight Python framework for building model-agnostic agents . Agents instantiate in microseconds with zero overhead. It supports all major providers, has built-in tools (web search, fi..."
  },
  {
    slug: "ain-autogen",
    title: "AutoGen — multi-agent conversations from Microsoft Research.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "autogen", "multi-agent", "microsoft", "python"],
    time: 16,
    words: 1200,
    excerpt: "AutoGen (v0.4, the \"AG2\" rewrite) is Microsoft Research's framework for multi-agent conversations . You define agents with roles, give them tools and models, and let them talk to each other in structured patterns — ro..."
  },
  {
    slug: "ain-baml",
    title: "BAML.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["structured-output", "ai-native", "baml", "schema"],
    time: 9,
    words: 1200,
    excerpt: "BAML defines schemas and prompt functions in a dedicated language, then compiles them into runtime clients."
  },
  {
    slug: "ain-browser-use",
    title: "Browser Use — let your agent browse the web like a human.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["agent-tool", "ai-native", "browser-use", "web-automation", "python"],
    time: 10,
    words: 1200,
    excerpt: "Browser Use gives AI agents a real browser. The model sees the page (via vision or structured DOM extraction), decides what to click/type/scroll, and the library executes those actions via Playwright. It handles multi..."
  },
  {
    slug: "ain-camel",
    title: "CAMEL — communicative agents for research and role-play.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "camel", "multi-agent", "research", "python"],
    time: 12,
    words: 1200,
    excerpt: "CAMEL ( Communicative Agents for \"Mind\" Exploration of Large Language Model Society ) is a research-born multi-agent framework built around role-playing . Two agents — an \"AI User\" and an \"AI Assistant\" — converse to ..."
  },
  {
    slug: "ain-chroma",
    title: "Chroma.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["vector-db", "ai-native", "chroma", "embeddings"],
    time: 9,
    words: 1200,
    excerpt: "Chroma is a developer-friendly embedding database for local-first and simple production RAG deployments."
  },
  {
    slug: "ain-cognee",
    title: "Cognee.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["knowledge-graph", "ai-native", "cognee", "memory"],
    time: 9,
    words: 1200,
    excerpt: "Cognee is an agent memory layer that organizes information as connected entities and relations instead of flat text chunks."
  },
  {
    slug: "ain-composio",
    title: "Composio — 250+ pre-built tool integrations for AI agents.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["agent-tool", "ai-native", "composio", "integrations", "python"],
    time: 10,
    words: 1200,
    excerpt: "Composio is a tool integration platform for AI agents. It provides 250+ pre-built integrations (GitHub, Slack, Gmail, Jira, Salesforce, databases, file systems…) with managed OAuth, auth, and API handling. Plug tools ..."
  },
  {
    slug: "ain-crewai",
    title: "CrewAI — role-based agent teams that just work.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "crewai", "multi-agent", "python"],
    time: 14,
    words: 1200,
    excerpt: "CrewAI lets you build multi-agent systems by thinking in roles : define agents with backstories, assign tasks with expected outputs, pick a process (sequential or hierarchical), and hit run. The fastest path from \"I n..."
  },
  {
    slug: "ain-deepeval",
    title: "DeepEval.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["evaluation", "ai-native", "deepeval", "python"],
    time: 9,
    words: 1200,
    excerpt: "DeepEval is a Python-first framework for LLM evaluation with metrics for correctness, relevance, faithfulness, and agent behavior."
  },
  {
    slug: "ain-dify",
    title: "Dify.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["workflow", "ai-native", "dify", "llmops"],
    time: 9,
    words: 1200,
    excerpt: "Dify is a visual LLM app and workflow platform for building chatbots, agents, and RAG flows."
  },
  {
    slug: "ain-firecrawl",
    ...
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["agent-tool", "ai-native", "firecrawl", "scraping", "python"],
    time: 9,
    words: 1200,
    excerpt: "Firecrawl is a web scraping API that crawls websites and returns clean markdown, structured data, or screenshots optimized for LLM consumption. Handles JavaScript rendering, anti-bot bypasses, and sitemaps. Use as an ..."
  },
  {
    slug: "ain-flyte",
    title: "Flyte.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["workflow", "ai-native", "flyte", "ml-pipelines"],
    time: 9,
    words: 1200,
    excerpt: "Flyte is a Kubernetes-native workflow orchestration platform for data and ML pipelines."
  },
  {
    slug: "ain-graphiti",
    title: "Graphiti.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["knowledge-graph", "ai-native", "graphiti", "agent-memory"],
    time: 9,
    words: 1200,
    excerpt: "Graphiti focuses on dynamic, temporal knowledge graphs for agent memory and retrieval."
  },
  {
    slug: "ain-guardrails-ai",
    title: "Guardrails AI.",
    date: "Jun 1, 2026",
    cat: "security",
    tags: ["guardrail", "ai-native", "guardrails-ai", "validation"],
    time: 9,
    words: 1200,
    excerpt: "Guardrails AI validates and constrains model outputs using schemas, validators, and re-ask logic."
  },
  {
    slug: "ain-guidance",
    title: "Guidance.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["structured-output", "ai-native", "guidance", "control"],
    time: 9,
    words: 1200,
    excerpt: "Guidance is a control language for constraining LLM generation with templates, regex, and token-level steering."
  },
  {
    slug: "ain-hatchet",
    title: "Hatchet.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["workflow", "ai-native", "hatchet", "durable-execution"],
    time: 9,
    words: 1200,
    excerpt: "Hatchet is a task and workflow engine for durable background jobs with retries, schedules, and visibility."
  },
  {
    slug: "ain-haystack",
    title: "Haystack.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["rag", "ai-native", "haystack", "pipelines"],
    time: 9,
    words: 1200,
    excerpt: "Haystack is a modular framework for search and RAG pipelines with retrievers, readers, routers, and evaluation."
  },
  {
    slug: "ain-instructor",
    title: "Instructor.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["structured-output", "ai-native", "instructor", "pydantic"],
    time: 9,
    words: 1200,
    excerpt: "Instructor wraps LLM calls to return validated Pydantic objects rather than raw text."
  },
  {
    slug: "ain-jina",
    title: "Jina Reader — URL to LLM-ready text in one HTTP call.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["agent-tool", "ai-native", "jina", "reader", "web"],
    time: 8,
    words: 1200,
    excerpt: "Jina Reader (r.jina.ai) is a free API that converts any URL to clean, LLM-friendly text. Prefix any URL with r.jina.ai/ and get back markdown. Also offers search ( s.jina.ai ) and grounding ( g.jina.ai ). Zero setup, ..."
  },
  {
    slug: "ain-kagent",
    title: "Kagent — Kubernetes-native AI agents as CRDs.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "kagent", "kubernetes", "agents"],
    time: 11,
    words: 1200,
    excerpt: "Kagent makes AI agents Kubernetes-native . You define agents, tools, and model connections as Custom Resources (CRDs) — kubectl apply an agent, and the controller deploys it as a pod with the right model, tools, and s..."
  },
  {
    slug: "ain-langgraph",
    title: "LangGraph — build agents as explicit state machines.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "langgraph", "agents", "state-machine", "python"],
    time: 18,
    words: 1200,
    excerpt: "LangGraph is the low-level runtime underneath LangChain's create_agent() . Where LangChain gives you a one-liner agent, LangGraph lets you define the agent as an explicit graph — nodes are functions, edges are conditi..."
  },
  {
    slug: "ain-letta",
    title: "Letta.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["state-memory", "ai-native", "letta", "agent-state"],
    time: 9,
    words: 1200,
    excerpt: "Letta is an agent runtime focused on persistent memory and stateful agent behavior across sessions."
  },
  {
    slug: "ain-llamaindex",
    title: "LlamaIndex.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["rag", "ai-native", "llamaindex", "indexing"],
    time: 9,
    words: 1200,
    excerpt: "LlamaIndex is a data framework for LLM apps, focused on ingestion, indexing, and retrieval over private data."
  },
  {
    slug: "ain-marqo",
    title: "Marqo.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["vector-db", "ai-native", "marqo", "multimodal"],
    time: 9,
    words: 1200,
    excerpt: "Marqo is a tensor search engine built for multimodal retrieval with embeddings and lexical relevance."
  },
  {
    slug: "ain-mcp",
    title: "MCP.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["protocol", "ai-native", "mcp", "tooling"],
    time: 9,
    words: 1200,
    excerpt: "Model Context Protocol standardizes how AI applications discover and call tools, resources, and prompts."
  },
  {
    slug: "ain-mem0",
    title: "Mem0.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["state-memory", "ai-native", "mem0", "personalization"],
    time: 9,
    words: 1200,
    excerpt: "Mem0 is a memory layer that stores and retrieves user-specific facts so agents can personalize over time."
  },
  {
    slug: "ain-milvus",
    title: "Milvus.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["vector-db", "ai-native", "milvus", "ann"],
    time: 9,
    words: 1200,
    excerpt: "Milvus is a high-scale open-source vector database optimized for ANN search and hybrid retrieval."
  },
  {
    slug: "ain-nemo-guardrails",
    title: "NeMo Guardrails.",
    date: "Jun 1, 2026",
    cat: "security",
    tags: ["guardrail", "ai-native", "nemo", "conversational-policy"],
    time: 9,
    words: 1200,
    excerpt: "NeMo Guardrails adds policy rails to conversational systems, controlling what the assistant can say and do."
  },
  {
    slug: "ain-neo4j",
    title: "Neo4j.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["knowledge-graph", "ai-native", "neo4j", "graph-db"],
    time: 9,
    words: 1200,
    excerpt: "Neo4j is a production graph database widely used for relationship-heavy retrieval and graph-RAG."
  },
  {
    slug: "ain-nvidia-guardrails",
    title: "NVIDIA Guardrails.",
    date: "Jun 1, 2026",
    cat: "security",
    tags: ["guardrail", "ai-native", "nvidia", "safety"],
    time: 9,
    words: 1200,
    excerpt: "NVIDIA Guardrails provides safety checks and policy enforcement for generative AI pipelines, including content safety and jailbreak defense."
  },
  {
    slug: "ain-opensearch",
    title: "OpenSearch.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["vector-db", "ai-native", "opensearch", "hybrid-search"],
    time: 9,
    words: 1200,
    excerpt: "OpenSearch supports vector search alongside classic BM25, filters, and analytics in one search engine."
  },
  {
    slug: "ain-opik",
    title: "Opik.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["evaluation", "ai-native", "opik", "observability"],
    time: 9,
    words: 1200,
    excerpt: "Opik combines tracing and evaluation so you can inspect real runs and grade output quality with datasets and judges."
  },
  {
    slug: "ain-outlines",
    title: "Outlines.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["structured-output", "ai-native", "outlines", "grammar"],
    time: 9,
    words: 1200,
    excerpt: "Outlines constrains text generation using regex and grammars to guarantee valid structured output."
  },
  {
    slug: "ain-pgvector",
    title: "pgvector.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["vector-db", "ai-native", "pgvector", "postgres"],
    time: 9,
    words: 1200,
    excerpt: "pgvector adds vector similarity search to PostgreSQL so you can keep metadata and vectors in one system."
  },
  {
    slug: "ain-promptfoo",
    title: "Promptfoo.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["evaluation", "ai-native", "promptfoo", "llm-eval"],
    time: 9,
    words: 1200,
    excerpt: "Promptfoo is a test harness for LLM apps that runs prompts, assertions, and regression suites across models before shipping changes."
  },
  {
    slug: "ain-pydantic-ai",
    title: "Pydantic AI — type-safe agents from the creators of Pydantic.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "pydantic-ai", "agents", "type-safe", "python"],
    time: 14,
    words: 1200,
    excerpt: "Pydantic AI brings the \"if it type-checks, it works\" philosophy to AI agents. From the team behind Pydantic, it gives you a clean Agent class with typed dependencies , typed results , typed tools , and a test mode tha..."
  },
  {
    slug: "ain-qdrant",
    title: "Qdrant.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["vector-db", "ai-native", "qdrant", "filtering"],
    time: 9,
    words: 1200,
    excerpt: "Qdrant is a vector database with strong filtering, payload support, and production-friendly APIs."
  },
  {
    slug: "ain-ragas",
    title: "Ragas.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["evaluation", "ai-native", "ragas", "rag"],
    time: 9,
    words: 1200,
    excerpt: "Ragas is a specialized evaluation toolkit for RAG pipelines, focused on retrieval quality and answer grounding."
  },
  {
    slug: "ain-ragflow",
    title: "RAGFlow.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["rag", "ai-native", "ragflow", "knowledge-base"],
    time: 9,
    words: 1200,
    excerpt: "RAGFlow is an end-to-end RAG platform for ingestion, chunking, retrieval, and answer generation with UI-driven workflows."
  },
  {
    slug: "ain-selenium",
    title: "Selenium — the original browser automation, now an agent tool.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["agent-tool", "ai-native", "selenium", "browser", "automation"],
    time: 10,
    words: 1200,
    excerpt: "Selenium is the veteran browser automation framework — WebDriver protocol, every browser, every language. In the AI agent era it's the fallback when you need raw browser control without AI-native abstractions. Stable,..."
  },
  {
    slug: "ain-semantic-kernel",
    title: "Semantic Kernel — Microsoft's enterprise SDK for AI orchestration.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "semantic-kernel", "microsoft", "dotnet", "python"],
    time: 15,
    words: 1200,
    excerpt: "Semantic Kernel (SK) is Microsoft's open-source SDK for integrating LLMs into enterprise applications. It's multi-language ( C#, Python, Java ), deeply integrated with Azure OpenAI, and designed around plugins (collec..."
  },
  {
    slug: "ain-smolagents",
    title: "Smolagents — Hugging Face's minimal code-first agent library.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "smolagents", "huggingface", "python"],
    time: 12,
    words: 1200,
    excerpt: "Smolagents is Hugging Face's agent library — radically minimal. An agent is ~1000 lines of code total. The key idea: the model writes Python code as its action (not JSON tool calls), which the framework executes in a ..."
  },
  {
    slug: "ain-strands-agents",
    title: "Strands Agents — AWS's open-source agent SDK.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["agent-framework", "ai-native", "strands-agents", "aws", "bedrock", "python"],
    time: 12,
    words: 1200,
    excerpt: "Strands Agents is AWS's open-source Python SDK for building AI agents. It uses a simple model-driven loop : the model decides what to do, calls tools, observes results, and repeats — no graph DSL, no chain abstraction..."
  },
  {
    slug: "ain-temporal",
    title: "Temporal.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["workflow", "ai-native", "temporal", "durable-execution"],
    time: 9,
    words: 1200,
    excerpt: "Temporal is a durable execution engine that lets you write long-running workflows as normal code."
  },
  {
    slug: "ain-trulens",
    title: "TruLens.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["evaluation", "ai-native", "trulens", "feedback"],
    time: 9,
    words: 1200,
    excerpt: "TruLens evaluates and tracks LLM applications using feedback functions over prompts, context, and outputs."
  },
  {
    slug: "ain-txtai",
    title: "txtai.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["rag", "ai-native", "txtai", "embeddings"],
    time: 9,
    words: 1200,
    excerpt: "txtai is an embeddings-powered search framework for semantic retrieval, workflows, and lightweight RAG."
  },
  {
    slug: "ain-unstructured",
    title: "Unstructured.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["rag", "ai-native", "unstructured", "ingestion"],
    time: 9,
    words: 1200,
    excerpt: "Unstructured focuses on document ingestion and parsing, turning messy enterprise files into clean chunks for RAG."
  },
  {
    slug: "ain-weaviate",
    title: "Weaviate.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["vector-db", "ai-native", "weaviate", "hybrid-search"],
    time: 9,
    words: 1200,
    excerpt: "Weaviate is a vector database with hybrid search, schema management, and integrated modules for embeddings and rerank."
  }
  {
    slug: "ain-tekton",
    title: "Tekton — cloud-native pipelines for building and testing AI artifacts.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "cicd", "tekton", "pipelines", "kubernetes"],
    time: 9,
    words: 1800,
    excerpt: "Tekton is a Kubernetes-native CI/CD framework built from reusable Tasks and Pipelines. It fits AI delivery chains that need build, test, package, and promote steps inside the cluster."
  },
  {
    slug: "ain-flux",
    title: "Flux — the other GitOps engine for Kubernetes.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "cicd", "flux", "gitops", "kubernetes"],
    time: 8,
    words: 1650,
    excerpt: "Flux keeps cluster state reconciled from Git with a controller-oriented design. It is a lean GitOps alternative for AI platform manifests and delivery loops."
  },
  {
    slug: "ain-argocd",
    title: "Argo CD — keep AI platform state synced from Git.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "cicd", "argocd", "gitops", "kubernetes"],
    time: 8,
    words: 1650,
    excerpt: "Argo CD continuously compares live Kubernetes state with Git and syncs the cluster back to the repo. It is the standard GitOps control plane for AI platform manifests."
  },
  {
    slug: "ain-langfuse",
    title: "Langfuse — trace prompts, tokens, and model calls end to end.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["ai-native", "observability", "langfuse", "llm-ops", "tracing"],
    time: 9,
    words: 1750,
    excerpt: "Langfuse records prompts, completions, token counts, latencies, and user feedback so teams can debug, evaluate, and measure the cost of AI apps."
  },
  {
    slug: "ain-grafana",
    title: "Grafana — make AI infrastructure visible and legible.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "observability", "grafana", "dashboards", "monitoring"],
    time: 8,
    words: 1600,
    excerpt: "Grafana turns metrics, traces, and logs into dashboards and alerts. It is the visual front end for the AI observability stack."
  },
  {
    slug: "ain-opentelemetry",
    title: "OpenTelemetry — one instrumentation standard for metrics, traces, and logs.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "observability", "opentelemetry", "tracing", "metrics"],
    time: 9,
    words: 1700,
    excerpt: "OpenTelemetry standardizes instrumentation and export for metrics, traces, and logs. It is the portable telemetry layer for AI services."
  },
  {
    slug: "ain-prometheus",
    title: "Prometheus — the metrics engine behind every serious platform.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "observability", "prometheus", "metrics", "monitoring"],
    time: 8,
    words: 1600,
    excerpt: "Prometheus scrapes time-series metrics, stores them efficiently, and lets you query them with PromQL. It is the base metrics store for AI infrastructure."
  },
  {
    slug: "ain-falco",
    title: "Falco — detect risky runtime behavior before it becomes an incident.",
    date: "Jun 1, 2026",
    cat: "security",
    tags: ["ai-native", "governance", "falco", "security", "runtime"],
    time: 9,
    words: 1750,
    excerpt: "Falco watches Linux syscalls and Kubernetes events to detect suspicious runtime behavior. It adds runtime detection to AI platform security."
  },
  {
    slug: "ain-kyverno",
    title: "Kyverno — Kubernetes policy in the language Kubernetes already speaks.",
    date: "Jun 1, 2026",
    cat: "security",
    tags: ["ai-native", "governance", "kyverno", "kubernetes", "policy"],
    time: 8,
    words: 1550,
    excerpt: "Kyverno is a Kubernetes-native policy engine written in YAML. It validates, mutates, and generates resources as admission-time guardrails."
  },
  {
    slug: "ain-opa",
    title: "OPA — policy as code for every AI platform decision.",
    date: "Jun 1, 2026",
    cat: "security",
    tags: ["ai-native", "governance", "opa", "rego", "policy"],
    time: 9,
    words: 1700,
    excerpt: "OPA lets you write policy in Rego and enforce it across Kubernetes, admission control, CI, APIs, and AI gateways. It centralizes platform decisions as code."
  },
  {
    slug: "ain-modelpack",
    title: "ModelPack — bundle a model, its runtime, and metadata into one artifact.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["ai-native", "model-registry", "modelpack", "oci", "packaging"],
    time: 8,
    words: 1500,
    excerpt: "ModelPack is a packaging pattern for shipping one model bundle with weights, tokenizer, config, and metadata. It reduces model/runtime drift."
  },
  {
    slug: "ain-oras",
    title: "ORAS — push and pull AI artifacts with the OCI registry protocol.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "model-registry", "oras", "oci", "artifact-registry"],
    time: 8,
    words: 1500,
    excerpt: "ORAS extends OCI registries to arbitrary artifacts. For AI that means models, tokenizers, prompts, and metadata can live in the same registry as containers."
  },
  {
    slug: "ain-kitops",
    title: "KitOps — package models like containers, with a ModelKit manifest.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "model-registry", "kitops", "oci", "modelpackaging"],
    time: 9,
    words: 1600,
    excerpt: "KitOps standardizes AI delivery by packaging a model, its code, dependencies, and metadata into a portable OCI artifact called a ModelKit."
  },
  {
    slug: "ain-huggingface-hub",
    title: "Hugging Face Hub — the GitHub for ML models, datasets, and spaces.",
    date: "Jun 1, 2026",
    cat: "ml",
    tags: ["ai-native", "model-registry", "huggingface", "model-hub", "datasets"],
    time: 10,
    words: 1800,
    excerpt: "Hugging Face Hub is the central platform for sharing and discovering ML models, datasets, and demo apps. It is the upstream registry for the open-source AI ecosystem."
  },
  {
    slug: "ain-rdma",
    title: "RDMA — zero-copy, kernel-bypass networking that makes GPU training scale.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "network", "rdma", "infiniband", "nccl"],
    time: 11,
    words: 1900,
    excerpt: "RDMA lets one machine read and write another machine's memory directly, bypassing the CPU and kernel. It is the protocol behind large-scale GPU training."
  },
  {
    slug: "ain-sriov",
    title: "SR-IOV — hardware-virtualized NICs that give pods bare-metal network speed.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "network", "sr-iov", "rdma", "kubernetes"],
    time: 10,
    words: 1800,
    excerpt: "SR-IOV splits one physical NIC into multiple VFs and passes them directly to pods. It gives AI workloads near-bare-metal network performance."
  },
  {
    slug: "ain-multus",
    title: "Multus — give a Kubernetes pod more than one network interface.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "network", "multus", "multi-nic", "kubernetes"],
    time: 9,
    words: 1750,
    excerpt: "Multus is a CNI meta-plugin that attaches multiple network interfaces to a single pod. It separates control-plane networking from high-speed AI data-plane networking."
  },
  {
    slug: "ain-cilium",
    title: "Cilium — eBPF-powered networking, security, and observability for Kubernetes.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "network", "cilium", "ebpf", "kubernetes"],
    time: 11,
    words: 1900,
    excerpt: "Cilium is the eBPF CNI that provides networking, policy, and observability for Kubernetes. It handles the control plane while RDMA and SR-IOV handle the data plane."
  },
  {
    slug: "ain-cubefs",
    title: "CubeFS — a cloud-native distributed filesystem with POSIX and S3 in one.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "storage", "cubefs", "distributed-storage", "kubernetes"],
    time: 10,
    words: 1850,
    excerpt: "CubeFS is a distributed filesystem that serves POSIX and S3 from one cluster. It is a full storage system for large-scale AI workloads."
  },
  {
    slug: "ain-minio",
    title: "MinIO — the S3-compatible object store you run yourself.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "storage", "minio", "object-storage", "kubernetes"],
    time: 9,
    words: 1700,
    excerpt: "MinIO is a high-performance, S3-compatible object store you deploy on your own hardware or cloud VMs. It is the storage backend for many AI pipelines."
  },
  {
    slug: "ain-alluxio",
    title: "Alluxio — a data orchestration layer that puts hot data next to GPU compute.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "storage", "alluxio", "caching", "kubernetes"],
    time: 10,
    words: 1800,
    excerpt: "Alluxio sits between compute and storage, caching hot data locally and presenting a unified namespace across backends. It cuts remote-storage latency for AI training."
  },
  {
    slug: "ain-juicefs",
    title: "JuiceFS — a POSIX filesystem built on object storage for AI workloads.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "storage", "juicefs", "distributed-storage", "kubernetes"],
    time: 10,
    words: 1850,
    excerpt: "JuiceFS gives AI training jobs the random-read performance of local NVMe while storing data in object storage. It is a POSIX filesystem with multi-level caching."
  },
  {
    slug: "ain-dra",
    title: "DRA — Kubernetes finally schedules GPUs like it means it.",
    date: "Jun 1, 2026",
    cat: "devops",
    tags: ["ai-native", "accelerator", "dra", "gpu", "kubernetes"],
    time: 10,
    words: 1900,
    excerpt: "Dynamic Resource Allocation is the GA Kubernetes framework for attribute-aware specialized hardware allocation. It replaces opaque device counts with claims and slices."
  },
  {
