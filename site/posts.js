...
const POSTS = [
  ...
  { slug:"deepseek-10-6-open-frontier", title:"The Future of Open-Weight Frontier Models.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1487, excerpt:"A grounded series conclusion: capacity, efficient attention, reasoning RL, agents, hardware, evaluation, governance, and concrete ways readers can contribute." },
  { slug:"deepseek-10-5-frontier-comparison", title:"DeepSeek-V4 vs GPT-5.4 vs Gemini 3.1 Pro.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1530, excerpt:"A dated, methodology-aware comparison of openness, modality, context, deployment, agent interfaces, economics, and benchmark evidence as of July 30, 2026." },
  { slug:"deepseek-10-4-beyond-cuda", title:"AI Infrastructure Beyond CUDA.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1470, excerpt:"What DeepSeek’s workloads demand from accelerators and interconnects: FP8 tiles, sparse experts, low-latency collectives, memory, compiler stacks, and portability." },
  { slug:"deepseek-10-3-million-token-context", title:"Engineering a Million-Token Context Window.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1508, excerpt:"Attention, KV cache, positional generalization, retrieval quality, prefill, decode, memory, distributed serving, and evaluations that expose fake long context." },
  { slug:"deepseek-10-2-v4-architecture", title:"DeepSeek-V4 Architecture: What Actually Changed.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1522, excerpt:"The official 2026 preview: V4-Pro and Flash, CSA+HCA hybrid attention, mHC, Muon, 32T+ tokens, reasoning modes, and million-token efficiency." },
  { slug:"deepseek-10-1-agentic-architecture", title:"DeepSeek for Agentic Systems.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-10"], time:8, words:1504, excerpt:"Perceive-plan-act loops, tool schemas, state, memory, verification, context management, security, and how V3.2/V4 reasoning changes the agent stack." },
  { slug:"deepseek-9-6-test-time-compute", title:"Test-Time Compute Scaling.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1503, excerpt:"Longer reasoning, best-of-N, majority voting, search, verifiers, adaptive budgets, scaling curves, latency, and the economics of spending inference compute." },
  { slug:"deepseek-9-5-self-verification", title:"Self-Verification: Capability, Pattern, or Illusion?.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1514, excerpt:"Separate internal checking, sampled reflection, external verifiers, process rewards, tool use, and redundant loops in reasoning models." },
  { slug:"deepseek-9-4-emergent-reasoning", title:"Emergent Reasoning in R1-Zero.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1528, excerpt:"What the paper actually shows about longer reasoning, reflection, self-correction, benchmark growth, readability problems, and the limits of the word 'emergent.'" },
  { slug:"deepseek-9-3-grpo-vs-ppo", title:"GRPO vs PPO: A Worked Derivation.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1514, excerpt:"Policy ratios, clipping, KL control, group-normalized advantages, the removed critic, memory savings, bias, and implementation pitfalls." },
  { slug:"deepseek-9-2-rlvr", title:"Reinforcement Learning With Verifiable Rewards.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1511, excerpt:"Why math and code permit objective rewards, how outcome and format signals work, where reward hacking appears, and how RLVR differs from preference RL." },
  { slug:"deepseek-9-1-r1-architecture", title:"DeepSeek-R1: Architecture and Training Pipeline.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-9"], time:8, words:1521, excerpt:"R1-Zero, cold-start data, reasoning RL, rejection-sampling SFT, final RL, distilled models, rewards, and what 'architecture' really means here." },
  { slug:"deepseek-8-8-memory-optimization", title:"GPU Memory Optimization for Giant MoE Models.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1483, excerpt:"Weights, gradients, optimizer state, activations, communication buffers, KV cache, checkpointing, ZeRO, precision, and a defensible memory budget." },
  { slug:"deepseek-8-7-communication", title:"Communication Bottlenecks in MoE Training.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1489, excerpt:"A practical network model for all-to-all traffic, topology, overlap, congestion, precision, and why communication can dominate accelerator arithmetic." },
  { slug:"deepseek-8-6-expert-parallelism", title:"Expert Parallelism at Scale.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1503, excerpt:"Token dispatch, expert placement, node-limited routing, grouped GEMM, load balance, and the two all-to-all operations inside every MoE layer." },
  { slug:"deepseek-8-5-distributed-training", title:"Distributed Training for DeepSeek-Scale MoE.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1489, excerpt:"Data, pipeline, expert, tensor, and optimizer-state parallelism; how V3 combines them and why DualPipe is necessary." },
  { slug:"deepseek-8-4-sparse-economics", title:"The Economics of Sparse Compute.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1493, excerpt:"Why 671B total and 37B active change FLOPs, memory, communication, utilization, serving, and cost in different ways." },
  { slug:"deepseek-8-3-loss-free-balancing", title:"Auxiliary-Loss-Free Load Balancing.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1527, excerpt:"The bias controller behind V3’s balanced experts: selection versus weighting, update dynamics, residual sequence loss, and operational telemetry." },
  { slug:"deepseek-8-2-v3-architecture", title:"DeepSeek-V3 Architecture Explained.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1509, excerpt:"A source-checked tour of 671B/37B, 14.8T tokens, MLA, 256 routed experts, MTP depth one, FP8, DualPipe, and post-training." },
  { slug:"deepseek-8-1-v2-architecture", title:"DeepSeek-V2 Architecture Breakdown.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-8"], time:8, words:1500, excerpt:"How MLA and DeepSeekMoE combine in the 236B/21B model, with configuration, training, post-training, economics, and the design lineage to V3." },
  { slug:"deepseek-7-6-fp8-pipeline", title:"DeepSeek-V3’s End-to-End FP8 Pipeline.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1526, excerpt:"The complete low-precision training system: operator policy, fine-grained scales, accurate accumulation, communication precision, stability evidence, and cost claims." },
  { slug:"deepseek-7-5-online-quantization", title:"Online Quantization During Training.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1523, excerpt:"Dynamic activation scales, static weight scales, distribution drift, calibration, kernel fusion, and the cost of quantizing every step." },
  { slug:"deepseek-7-4-accumulation-precision", title:"Accumulation Precision and FP8 Stability.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1505, excerpt:"Low-precision products, wide accumulators, partial sums, error growth, and the hardware behavior DeepSeek had to work around." },
  { slug:"deepseek-7-3-fine-grained-fp8", title:"Fine-Grained FP8 Quantization in DeepSeek.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1522, excerpt:"DeepSeek-V3’s tile and block scaling: why activation outliers demand local scales and what custom kernels must do." },
  { slug:"deepseek-7-2-mixed-precision", title:"Mixed-Precision Training Explained.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1543, excerpt:"Why BF16, FP16, and FP32 coexist in one training step, how autocast and loss scaling work, and which operations must stay precise." },
  { slug:"deepseek-7-1-quantization", title:"LLM Quantization: The Complete Mental Model.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-7"], time:8, words:1560, excerpt:"From FP32 to FP8 and INT4: scales, zero points, granularity, calibration, outliers, PTQ, QAT, memory, bandwidth, and accuracy." },
  { slug:"deepseek-6-6-speculative-decoding", title:"Speculative Decoding With MTP Drafts.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1559, excerpt:"Draft several tokens cheaply, verify them in parallel, preserve the target distribution, and understand when MTP helps—or does not." },
  { slug:"deepseek-6-5-mtp-from-scratch", title:"MTP From Scratch in PyTorch.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1512, excerpt:"Add a sequential DeepSeek-style MTP branch to a tiny causal Transformer with correct shifts, shared parameters, losses, and tests." },
  { slug:"deepseek-6-4-mtp-training", title:"MTP Training Architecture and Stability.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1587, excerpt:"Tensor alignment, gradient flow, loss scheduling, parameter sharing, distributed placement, and diagnostics for a stable MTP training run." },
  { slug:"deepseek-6-3-deepseek-mtp", title:"How DeepSeek Redesigned MTP.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1607, excerpt:"DeepSeek-V3’s sequential MTP modules preserve a causal chain, share expensive endpoints, and can disappear cleanly at inference." },
  { slug:"deepseek-6-2-mtp-introduction", title:"Multi-Token Prediction From First Principles.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1621, excerpt:"Predict several future offsets from every position, understand the loss, and see why this is a training objective rather than permission to emit tokens independently." },
  { slug:"deepseek-6-1-ntp-limitations", title:"Why Next-Token Prediction Is Limited.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-6"], time:8, words:1664, excerpt:"The standard language-model objective is powerful but locally supervised; this article separates what it learns brilliantly from what it does not explicitly reward." },
  { slug:"deepseek-5-7-moe-from-scratch", title:"Coding DeepSeekMoE From Scratch.", date:"Jul 30, 2026", cat:"ml", tags:["deepseek","phase-5"], time:8, words:1671, excerpt:"A faithful, readable PyTorch MoE block: SwiGLU experts, sigmoid routing, top-k dispatch, shared experts, balancing bias, tests, and cost accounting." },
