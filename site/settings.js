/* settings.js — reader settings panel (theme picker, font size, line width, font toggle) */
(function () {
  var THEMES = [
  ...
  if (savedWidth !== "lw-normal") {
    document.documentElement.classList.add(savedWidth);
  }
